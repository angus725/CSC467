...
//data_type get_func_result_type(node* N)
//{
...
//		// use the CalcFuncResultType() call
//    	switch(N->func_call_exp.func) { // this can be merged into the CalcFuncResultType call's return 
//    	case FUNC_LIT:
